...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        Window::new(0x6000, 0x7FFF, 8 * KIBIBYTE, Bank::EMPTY),
        Window::new(0x8000, 0x9FFF, 8 * KIBIBYTE, Bank::switchable_rom(P2)),
        Window::new(0xA000, 0xBFFF, 8 * KIBIBYTE, Bank::switchable_rom(P1)),
        Window::new(0xC000, 0xDFFF, 8 * KIBIBYTE, Bank::switchable_rom(P0)),
        Window::new(0xE000, 0xFFFF, 8 * KIBIBYTE, Bank::fixed_rom(BankIndex::LAST)),
    ])
    .chr_layout(&[
    ...
    .chr_layout(&[
        ...
        Window::new(0x0400, 0x07FF, 1 * KIBIBYTE, Bank::switchable_rom(C6)),
        Window::new(0x0800, 0x0BFF, 1 * KIBIBYTE, Bank::switchable_rom(C1)),
        Window::new(0x0C00, 0x0FFF, 1 * KIBIBYTE, Bank::switchable_rom(C7)),
        Window::new(0x1000, 0x13FF, 1 * KIBIBYTE, Bank::switchable_rom(C2)),
        Window::new(0x1400, 0x17FF, 1 * KIBIBYTE, Bank::switchable_rom(C3)),
        Window::new(0x1800, 0x1BFF, 1 * KIBIBYTE, Bank::switchable_rom(C4)),
        Window::new(0x1C00, 0x1FFF, 1 * KIBIBYTE, Bank::switchable_rom(C5)),
    ...
    .chr_layout(&[
        Window::new(0x0000, 0x03FF, 1 * KIBIBYTE, Bank::switchable_rom(C2)),
        Window::new(0x0400, 0x07FF, 1 * KIBIBYTE, Bank::switchable_rom(C3)),
        Window::new(0x0800, 0x0BFF, 1 * KIBIBYTE, Bank::switchable_rom(C4)),
        Window::new(0x0C00, 0x0FFF, 1 * KIBIBYTE, Bank::switchable_rom(C5)),
        Window::new(0x1000, 0x17FF, 2 * KIBIBYTE, Bank::switchable_rom(C0)),
        Window::new(0x1800, 0x1FFF, 2 * KIBIBYTE, Bank::switchable_rom(C1)),
    ])
    .chr_layout(&[
        Window::new(0x0000, 0x03FF, 1 * KIBIBYTE, Bank::switchable_rom(C2)),
        Window::new(0x0400, 0x07FF, 1 * KIBIBYTE, Bank::switchable_rom(C3)),
        Window::new(0x0800, 0x0BFF, 1 * KIBIBYTE, Bank::switchable_rom(C4)),
        Window::new(0x0C00, 0x0FFF, 1 * KIBIBYTE, Bank::switchable_rom(C5)),
        Window::new(0x1000, 0x13FF, 1 * KIBIBYTE, Bank::switchable_rom(C0)),
        Window::new(0x1400, 0x17FF, 1 * KIBIBYTE, Bank::switchable_rom(C6)),
        Window::new(0x1800, 0x1BFF, 1 * KIBIBYTE, Bank::switchable_rom(C1)),
