...
impl Mapper for Mapper023 {
    ...
    fn write_to_cartridge_space(&mut self, params: &mut MapperParams, address: CpuAddress, value: u8) {
        match address.to_raw() {
            ...
            0xB000 => self.chr_bank_lows[0] = value & 0b0000_1111,
            0xB002 => self.chr_bank_lows[1] = value & 0b0000_1111,
            0xC000 => self.chr_bank_lows[2] = value & 0b0000_1111,
            0xC002 => self.chr_bank_lows[3] = value & 0b0000_1111,
            0xD000 => self.chr_bank_lows[4] = value & 0b0000_1111,
            0xD002 => self.chr_bank_lows[5] = value & 0b0000_1111,
            0xE000 => self.chr_bank_lows[6] = value & 0b0000_1111,
            0xE002 => self.chr_bank_lows[7] = value & 0b0000_1111,
            0xB001 => params.chr_memory_mut().set_bank_index_register(C0, bank_index(self.chr_bank_lows[0], value)),
            0xB003 => params.chr_memory_mut().set_bank_index_register(C1, bank_index(self.chr_bank_lows[1], value)),
            0xC001 => params.chr_memory_mut().set_bank_index_register(C2, bank_index(self.chr_bank_lows[2], value)),
            0xC003 => params.chr_memory_mut().set_bank_index_register(C3, bank_index(self.chr_bank_lows[3], value)),
            0xD001 => params.chr_memory_mut().set_bank_index_register(C4, bank_index(self.chr_bank_lows[4], value)),
            0xD003 => params.chr_memory_mut().set_bank_index_register(C5, bank_index(self.chr_bank_lows[5], value)),
            0xE001 => params.chr_memory_mut().set_bank_index_register(C6, bank_index(self.chr_bank_lows[6], value)),
            0xE003 => params.chr_memory_mut().set_bank_index_register(C7, bank_index(self.chr_bank_lows[7], value)),
...
fn bank_index(low: u8, high: u8) -> u16 {
    (u16::from(high & 0b0001_1111) << 4) | u16::from(low)
}
