...
// Identical to submapper 0, except NEC's IRQ behavior is used instead of Sharp's.
pub struct Mapper004_3 {
    selected_register_id: BankIndexRegisterId,
    irq_state: McAccIrqState,
}

impl Mapper for Mapper004_3 {
