...
impl Mapper for Mapper018 {
    ...
    fn write_to_cartridge_space(&mut self, params: &mut MapperParams, address: CpuAddress, value: u8) {
        ...
        match address & 0b1111_0000_0000_0011 {
            ...
            0x8000 => params.set_bank_index_register_bits(P0, value     , 0b0000_1111),
            0x8001 => params.set_bank_index_register_bits(P0, value << 4, 0b0011_0000),
            0x8002 => params.set_bank_index_register_bits(P1, value     , 0b0000_1111),
            0x8003 => params.set_bank_index_register_bits(P1, value << 4, 0b0011_0000),
            0x9000 => params.set_bank_index_register_bits(P2, value     , 0b0000_1111),
            0x9001 => params.set_bank_index_register_bits(P2, value << 4, 0b0011_0000),
            0x9002 => self.work_ram_write_enabled = value & 0b0000_0010 != 0,
            0x9003 => { /* Do nothing */ }
            0xA000 => params.set_bank_index_register_bits(C0, value     , 0b0000_1111),
            0xA001 => params.set_bank_index_register_bits(C0, value << 4, 0b1111_0000),
            0xA002 => params.set_bank_index_register_bits(C1, value     , 0b0000_1111),
            0xA003 => params.set_bank_index_register_bits(C1, value << 4, 0b1111_0000),
            0xB000 => params.set_bank_index_register_bits(C2, value     , 0b0000_1111),
            0xB001 => params.set_bank_index_register_bits(C2, value << 4, 0b1111_0000),
            0xB002 => params.set_bank_index_register_bits(C3, value     , 0b0000_1111),
            0xB003 => params.set_bank_index_register_bits(C3, value << 4, 0b1111_0000),
            0xC000 => params.set_bank_index_register_bits(C4, value     , 0b0000_1111),
            0xC001 => params.set_bank_index_register_bits(C4, value << 4, 0b1111_0000),
            0xC002 => params.set_bank_index_register_bits(C5, value     , 0b0000_1111),
            0xC003 => params.set_bank_index_register_bits(C5, value << 4, 0b1111_0000),
            0xD000 => params.set_bank_index_register_bits(C6, value     , 0b0000_1111),
            0xD001 => params.set_bank_index_register_bits(C6, value << 4, 0b1111_0000),
            0xD002 => params.set_bank_index_register_bits(C7, value     , 0b0000_1111),
            0xD003 => params.set_bank_index_register_bits(C7, value << 4, 0b1111_0000),
