...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        ...
        PrgWindow::new(0xC000, 0xFFFF, 16 * KIBIBYTE, PrgBank::ROM.fixed_number(0)),
    ])
...
const CHR_IDS: [ChrBankRegisterId; 4] = [C, D, E, F];
...
impl Mapper for Mapper190 {
    fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
        match *addr {
            ...
            0x8000..=0x9FFF => bus.set_prg_register(P, value & 0b0111),
            0xC000..=0xDFFF => bus.set_prg_register(P, (value & 0b0111) | 0b1000),
