...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        PrgWindow::new(0x6000, 0x67FF, 2 * KIBIBYTE, Prg::RAM_OR_ABSENT).fixed_number(0).read_write_status(RS0, WS0),
        PrgWindow::new(0x6800, 0x6FFF, 2 * KIBIBYTE, Prg::RAM_OR_ABSENT).fixed_number(2).read_write_status(RS1, WS1),
        PrgWindow::new(0x7000, 0x73FF, 1 * KIBIBYTE, Prg::RAM_OR_ABSENT).fixed_number(4).read_write_status(RS2, WS2),
        PrgWindow::new(0x7400, 0x7FFF, 3 * KIBIBYTE, Prg::ABSENT),
