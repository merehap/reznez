...
impl Mapper for Mapper032 {
    fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
        match *addr {
            ...
            0x8000..=0x8007 => bus.set_prg_register(P0, value & 0b1_1111),
            0x9000..=0x9007 => {
                let fields = splitbits!(min=u8, value, "......pm");
                bus.set_prg_layout(fields.p);
                bus.set_name_table_mirroring(fields.m);
            }
            0xA000..=0xA007 => bus.set_prg_register(P1, value & 0b1_1111),
            0xB000 => bus.set_chr_register(C0, value),
            0xB001 => bus.set_chr_register(C1, value),
            0xB002 => bus.set_chr_register(C2, value),
            0xB003 => bus.set_chr_register(C3, value),
            0xB004 => bus.set_chr_register(C4, value),
            0xB005 => bus.set_chr_register(C5, value),
            0xB006 => bus.set_chr_register(C6, value),
            0xB007 => bus.set_chr_register(C7, value),
            _ => { /* Do nothing. */ }
        }
    }
