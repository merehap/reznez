...
impl Mapper for Mapper016_5 {
    fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
        match *addr & 0x800F {
            ...
            0x8000 => bus.set_chr_register(C, value),
            0x8001 => bus.set_chr_register(D, value),
            0x8002 => bus.set_chr_register(E, value),
            0x8003 => bus.set_chr_register(F, value),
            0x8004 => bus.set_chr_register(G, value),
            0x8005 => bus.set_chr_register(H, value),
            0x8006 => bus.set_chr_register(I, value),
            0x8007 => bus.set_chr_register(J, value),
            0x8008 => bus.set_prg_register(P, value & 0b1111),
