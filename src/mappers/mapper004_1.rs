...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        ...
        PrgWindow::new(0x7000, 0x71FF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(0).read_write_status(R0, W0)),
        PrgWindow::new(0x7200, 0x73FF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(1).read_write_status(R1, W1)),
        PrgWindow::new(0x7400, 0x75FF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(0).read_write_status(R0, W0)),
        PrgWindow::new(0x7600, 0x77FF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(1).read_write_status(R1, W1)),
        PrgWindow::new(0x7800, 0x79FF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(0).read_write_status(R0, W0)),
        PrgWindow::new(0x7A00, 0x7BFF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(1).read_write_status(R1, W1)),
        PrgWindow::new(0x7C00, 0x7DFF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(0).read_write_status(R0, W0)),
        PrgWindow::new(0x7E00, 0x7FFF, KIBIBYTE / 2, PrgBank::WORK_RAM.fixed_number(1).read_write_status(R1, W1)),
