...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        ...
        PrgWindow::new(0x7400, 0x75FF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7000)),
        PrgWindow::new(0x7600, 0x77FF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7200)),
        PrgWindow::new(0x7800, 0x79FF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7000)),
        PrgWindow::new(0x7A00, 0x7BFF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7200)),
        PrgWindow::new(0x7C00, 0x7DFF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7000)),
        PrgWindow::new(0x7E00, 0x7FFF, KIBIBYTE / 2, PrgBank::MirrorOf(0x7200)),
