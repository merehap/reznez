    ...
    fn write_register(&mut self, mem: &mut Memory, addr: CpuAddress, value: u8) {
        ...
        match *addr & 0x8C17 {
            0x8000 => {
                ...
                mem.set_prg_register(P4, fields.p);
            }
            0x8400 => {
            ...
            0x8C00 => mem.set_prg_register(P0, value & 0b1111),
            0x8C01 => mem.set_prg_register(P1, value & 0b1111),
            0x8C02 => mem.set_prg_register(P2, value & 0b1111),
            0x8C03 => mem.set_prg_register(P3, value & 0b1111),
            0x8C10 => mem.set_chr_register(C0, value),
            0x8C11 => mem.set_chr_register(C1, value),
            0x8C16 => mem.set_chr_register(C2, value),
            0x8C17 => mem.set_chr_register(C3, value),
            _ => { /* Do nothing. */ }
        }
    }
