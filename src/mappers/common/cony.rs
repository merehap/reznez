...
impl Cony {
    ...
    pub fn peek_register(&self, bus: &Bus, addr: CpuAddress) -> ReadResult {
    ...
    pub fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
    ...
    pub fn on_end_of_cpu_cycle(&mut self, bus: &mut Bus) {
