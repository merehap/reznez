...
impl Mapper for Mapper016_4 {
    fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
        match *addr & 0xE00F {
            ...
            0x6004 => bus.set_chr_register(G, value),
            0x6005 => bus.set_chr_register(H, value),
            0x6006 => bus.set_chr_register(I, value),
            0x6007 => bus.set_chr_register(J, value),
            0x6008 => bus.set_prg_register(P, value & 0b1111),
