...
impl Mapper for Mapper067 {
    fn write_register(&mut self, bus: &mut Bus, addr: CpuAddress, value: u8) {
        match *addr {
            ...
            0x8800..=0x97FF => bus.set_chr_register(C, value & 0b0011_1111),
            0x9800..=0xA7FF => bus.set_chr_register(D, value & 0b0011_1111),
            0xA800..=0xB7FF => bus.set_chr_register(E, value & 0b0011_1111),
            0xB800..=0xC7FF => bus.set_chr_register(F, value & 0b0011_1111),
            0xE800..=0xF7FF => bus.set_name_table_mirroring(value & 0b11),
            0xF800..=0xFFFF => bus.set_prg_register(P, value & 0b1111),
