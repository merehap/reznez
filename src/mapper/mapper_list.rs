...
use crate::mapper::mapper::{Mapper, LookupResult};
use crate::mapper::mappers as m;
use crate::mapper::mappers::mmc1::board::Mmc1BoardError;
...
pub fn try_lookup_mapper(metadata: &ResolvedMetadata) -> LookupResult {
    ...
    match (metadata.mapper_number, metadata.submapper_number) {
        ...
        (103, None) => m::mapper103::Mapper103.supported(),
        ...
        (208, None) => UnspecifiedSubmapper,
        // Street Fighter IV
        (208, Some(0)) => m::mapper208::Mapper208::new().supported(),
        ...
        (225, None) => m::mapper225::Mapper225::default().supported(),
        // 76-in-1 and other multicarts
        (226, None) => m::mapper226::Mapper226.supported(),
        (227, _) => TodoMapper,
        // Active Enterprises
        (228, None) => m::mapper228::Mapper228.supported(),
        // BMC 31-IN-1
...
mod tests {
    use super::*;
    use crate::mapper::mapper::KIBIBYTE;
    ...
    fn banked() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
    ...
    fn two_layouts() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("p₀₄p₀₃p₀₂p₀₁p₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₄q₀₃q₀₂q₀₁q₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
    ...
    fn different_bank_sizes() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("p₀₃p₀₂p₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                ],
                [
                    None,
                    Some("p₀₃p₀₂p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("p₀₃p₀₂p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                ],
    ...
    fn outer_bank() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("o₀₁o₀₀p₀₃p₀₂p₀₁p₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("o₀₁o₀₀q₀₃q₀₂q₀₁q₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
    ...
    fn outer_bank_undersized() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("o₀₀p₀₃p₀₂p₀₁p₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("o₀₀q₀₃q₀₂q₀₁q₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
    ...
    fn outer_bank_severely_undersized() {
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    None,
                    Some("p₀₂p₀₁p₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁q₀₀a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
        ...
        test_mapper_address_template(TestParams {
            ...
            expected: &[
                [
                    ...
                    Some("q₀₂q₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁a₁₄a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                ],
                ...
                [
                    ...
                    Some("0₀₂0₀₁0₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁q₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                    Some("q₀₂q₀₁q₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
                ],
                [
                    Some("p₀₂p₀₁p₀₀a₁₃a₁₂a₁₁a₁₀a₀₉a₀₈a₀₇a₀₆a₀₅a₀₄a₀₃a₀₂a₀₁a₀₀"),
