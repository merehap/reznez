...
const LAYOUT: Layout = Layout::builder()
    ...
    .prg_layout(&[
        PrgWindow::new(0x6000, 0x6FFF, 4 * KIBIBYTE, Prg::ABSENT),
        PrgWindow::new(0x7000, 0x71FF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(0).read_write_status(RS0, WS0),
        PrgWindow::new(0x7200, 0x73FF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(1).read_write_status(RS1, WS1),
        PrgWindow::new(0x7400, 0x75FF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(0).read_write_status(RS0, WS0),
        PrgWindow::new(0x7600, 0x77FF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(1).read_write_status(RS1, WS1),
        PrgWindow::new(0x7800, 0x79FF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(0).read_write_status(RS0, WS0),
        PrgWindow::new(0x7A00, 0x7BFF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(1).read_write_status(RS1, WS1),
        PrgWindow::new(0x7C00, 0x7DFF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(0).read_write_status(RS0, WS0),
        PrgWindow::new(0x7E00, 0x7FFF, KIBIBYTE / 2, Prg::RAM_OR_ABSENT).fixed_number(1).read_write_status(RS1, WS1),
